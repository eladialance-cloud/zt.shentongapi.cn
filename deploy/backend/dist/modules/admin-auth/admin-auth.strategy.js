...
let AdminAuthStrategy = class AdminAuthStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'admin-jwt') {
    constructor(config) {
        super({
...
exports.AdminAuthStrategy = AdminAuthStrategy = __decorate([
