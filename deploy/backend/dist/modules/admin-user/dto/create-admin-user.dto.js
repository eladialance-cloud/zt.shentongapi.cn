...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[a-zA-Z0-9_]{3,32}$/, {
        message: '用户名只能包含字母、数字、下划线,长度3-32',
    }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '密码（明文，服务端 bcrypt 哈希）', example: 'Pass1234' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '用户等级 0-5', example: 0, required: false, default: 0 }),
    (0, class_validator_1.IsInt)({ message: '等级必须为整数' }),
    (0, class_validator_1.Min)(0, { message: '等级最小为 0' }),
    (0, class_validator_1.Max)(5, { message: '等级最大为 5' }),
    __metadata("design:type", Number)
], CreateAdminUserDto.prototype, "level", void 0);
