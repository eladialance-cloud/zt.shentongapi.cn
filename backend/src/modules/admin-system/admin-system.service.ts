...
const DEFAULT_SECTION_CONFIG: Record<string, Record<string, unknown>> = {
  ...
  oral_workshop: {
    ...
    reviewModel: '',
    volcanoApiKey: '',
    voiceEndpoint: 'https://openspeech.bytedance.com/api/v3/tts/unidirectional',
    voiceModelV1: '',
    voiceModelV2: '',
    voiceModel: '',
    voiceApiKey: '',
    voiceResourceId: 'seed-icl-2.0',
    voiceCloneEndpoint: 'https://openspeech.bytedance.com/api/v3/tts/voice_clone',
    voiceFormat: 'mp3',
    voiceSampleRate: 24000,
    voiceSpeechRate: 0,
    voiceLoudnessRate: 0,
    voiceEnableSubtitle: false,
    voiceRefAudioUrl: '',
    voiceSpeakerId: '',
    dhEndpoint: '',
    dhSubmitPath: '/digital-human/submit',
    dhQueryPath: '/digital-human/query',
    dhModelVersion: 'V1',
    dhDefaultImageId: '',
    sttProvider: 'openai',
    sttModel: 'whisper-1',
