...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  {
    ...
    generation: {
      // 文生图：2026 新一代图像模型（wan2.7-image*/qwen-image-* 等）走 image-generation/generation（input.messages 消息体）
      imagesPath: 'https://dashscope.aliyuncs.com/api/v1/services/aigc/image-generation/generation',
      imageTaskPath: 'https://dashscope.aliyuncs.com/api/v1/tasks/{id}',
      imageResultUrlPath: 'output.choices[0].message.content[0].image',
...
export const MODEL_TEMPLATES: ModelTemplate[] = [
  ...
  { key: 'wan2.7-image', vendor: 'aliyun-dashscope', name: '通义万相-文生图2.7', callMode: 'image', description: '文生图（新一代·异步）', upstreamModelId: 'wan2.7-image', specValues: { resolutions: ['720P', '1080P'], defaultResolution: '720P', aspectRatios: ['1:1', '16:9'], maxImages: 4 }, generationParams: { image_sizes: ['1024x1024', '1280x720'] }, recommendedScenarioTags: ['文生图'], referencePrice: { pricePerImage: 10 }, verified: true },
  { key: 'wan2.7-image-pro', vendor: 'aliyun-dashscope', name: '通义万相-文生图Pro2.7', callMode: 'image', description: '文生图（新一代·高清增强）', upstreamModelId: 'wan2.7-image-pro', specValues: { resolutions: ['720P', '1080P'], defaultResolution: '720P', aspectRatios: ['1:1', '16:9'], maxImages: 4 }, generationParams: { image_sizes: ['1024x1024', '1280x720'] }, recommendedScenarioTags: ['文生图'], referencePrice: { pricePerImage: 20 }, verified: true },
  { key: 'qwen-image-3.0', vendor: 'aliyun-dashscope', name: '通义千问-图像3.0', callMode: 'image', description: '文生图（新一代·旗舰）', upstreamModelId: 'qwen-image-3.0', specValues: { resolutions: ['720P', '1080P'], defaultResolution: '720P', aspectRatios: ['1:1', '16:9'], maxImages: 4 }, generationParams: { image_sizes: ['1024x1024', '1280x720'] }, recommendedScenarioTags: ['文生图'], referencePrice: { pricePerImage: 10 }, verified: true },
