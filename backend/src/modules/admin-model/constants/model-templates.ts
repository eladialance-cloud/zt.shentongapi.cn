...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  {
    ...
    generation: {
      ...
      taskPath: 'https://dashscope.aliyuncs.com/api/v1/services/aigc/video-generation/tasks/{id}',
...
export const MODEL_TEMPLATES: ModelTemplate[] = [
  ...
  { key: 'wanx-sketch', vendor: 'aliyun-dashscope', name: '通义万相-线稿生图', callMode: 'image_edit', description: '线稿/草图生图（image_edit 创意工具：输入图+提示词→成图；请求形状由 images_style 配置驱动）', upstreamModelId: 'wanx2.1-sketch-to-image-lite', specValues: { resolutions: ['720P', '1080P'], defaultResolution: '720P', aspectRatios: ['1:1', '16:9'], maxImages: 1 }, generationParams: { images_style: 'multipart', images_path: 'https://dashscope.aliyuncs.com/compatible-mode/v1/images/edits', image_fields: ['sketch'], prompt_field: 'prompt', model_field: 'model' }, recommendedScenarioTags: ['图像编辑'], referencePrice: { pricePerImage: 12 }, verified: false },
