...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { category: "tools", name: "/memory", description: "本地 Hermes 记忆（USER.md / MEMORY.md）" },
