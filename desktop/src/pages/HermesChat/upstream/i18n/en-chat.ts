export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let ShenTong Bot and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "ShenTong Bot needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let ShenTong Bot decide",
    skipped: "Skipped — ShenTong Bot decided",
  ...
  commands: {
    ...
    version: "Show ShenTong Bot version",
  },
  ...
  followUs: {
    ...
    description:
      "Stay up to date with the latest ShenTong Bot features, tips, and updates. Follow us on X!",
    follow: "Follow",
    notNow: "Not Now",
  },
} as const;
