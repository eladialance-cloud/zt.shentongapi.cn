...
const SHORTCUTS: ShortcutItem[] = [
  { key: 'users', label: '用户管理', desc: '用户/等级/积分/订单/设备', icon: <TeamOutlined />, path: '/admin/users' },
  { key: 'apikey', label: 'Key 池', desc: 'API Key 池管理', icon: <KeyOutlined />, path: '/admin/api-key-pool' },
  { key: 'agent', label: 'Agent', desc: 'Agent 审核与管理', icon: <RobotOutlined />, path: '/admin/agents' },
  { key: 'workflow', label: '工作流', desc: '工作流审核', icon: <AppstoreOutlined />, path: '/admin/workflows' },
  { key: 'plugin', label: '插件', desc: '插件审核', icon: <ToolOutlined />, path: '/admin/plugins' },
  { key: 'model', label: '模型', desc: '模型配置', icon: <CloudServerOutlined />, path: '/admin/models' },
  { key: 'finance', label: '财务', desc: '订单与退款', icon: <DollarOutlined />, path: '/admin/finance' },
  { key: 'audit', label: '审核', desc: '审核中心', icon: <AuditOutlined />, path: '/admin/audit' },
  { key: 'stats', label: '统计', desc: '统计报表', icon: <BarChartOutlined />, path: '/admin/stats' },
  { key: 'version', label: '版本', desc: '版本发布', icon: <CloudSyncOutlined />, path: '/admin/versions' },
  { key: 'system', label: '系统', desc: '系统配置', icon: <SettingOutlined />, path: '/admin/system' },
  { key: 'dashboard', label: '仪表盘', desc: '返回首页', icon: <DashboardOutlined />, path: '/admin/dashboard' }
]
