...
const CORE_TABS: TabItem[] = [
  ...
  { key: 'workflows', label: '工作流', icon: <ApartmentOutlined />, path: '/workflows' },
...
const MORE_TABS: TabItem[] = [
  ...
  { key: 'agent-market', label: 'Agent市场', icon: <AppstoreOutlined />, path: '/agent-market' },
  { key: 'mcp-market', label: 'MCP市场', icon: <ToolOutlined />, path: '/mcp-market' },
  { key: 'channels-publish', label: '发布', icon: <SendOutlined />, path: '/channels/publish' },
